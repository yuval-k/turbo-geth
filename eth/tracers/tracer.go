...
func (jst *Tracer) CaptureState(env *vm.EVM, pc uint64, op vm.OpCode, gas, cost uint64, memory *vm.Memory, stack *stack2.Stack, contract *vm.Contract, depth int, err error) error {
	if jst.err == nil {
...
func (jst *Tracer) CaptureFault(env *vm.EVM, pc uint64, op vm.OpCode, gas, cost uint64, memory *vm.Memory, stack *stack2.Stack, contract *vm.Contract, depth int, err error) error {
	if jst.err == nil {
