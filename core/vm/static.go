...
var Commands = map[OpCode]Command{
	...
	MSTORE:   NewCommand(2, 0, Static),
	MSTORE8:  NewCommand(2, 0, Static),
	SLOAD:    NewCommand(1, 1, NotStatic),
	SSTORE:   NewCommand(2, 1, Static),
	JUMP:     NewCommand(1, 0, Static),
	JUMPI:    NewCommand(2, 0, Static),
	PC:       NewCommand(0, 1, Static),
	MSIZE:    NewCommand(0, 1, Static),
	GAS:      NewCommand(0, 1, NotStatic),
	JUMPDEST: NewCommand(0, 0, Static),
